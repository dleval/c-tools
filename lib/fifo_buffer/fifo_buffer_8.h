/**
 * @file fifo_buffer_8.h
 * @author David LEVAL (dleval@dle-dev.com)
 * @brief Tool for fifo memory with configurable size (optimized for 8-bit data)
 * @version 1.0
 * @date 2021-11-08
 * 
...
#ifndef FIFOBUFFER_8_H
#define	FIFOBUFFER_8_H
